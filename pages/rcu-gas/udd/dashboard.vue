 ...
 components: {
  ...
  methods: {
    ...
    esporta(){
      ...
      this.$axios.post('/api/rcu-gas/udd/download-file/', {mese: this.mesi.indexOf(this.meseSelezionato)+1,anno:this.annoSelezionato},{
    ...
    async sintesiInformation() {
      this.$axios.get('/api/rcu-gas/udd/sintesi-information', {
        headers:{
          'Secret-Key' : this.$store.getters['authToken']
        },
        params: {
    ...
    async chartIncrementoAnnPodInformation(){
      this.$axios.get('/api/rcu-gas/udd/chart-incremento-pod-information', {
        headers:{
          'Secret-Key' : this.$store.getters['authToken']
        },
        params: {
    ...
    async chartIncrementoAnnVolumeInformation(){
      this.$axios.get('/api/rcu-gas/udd/chart-incremento-volume-information', {
        headers:{
          'Secret-Key' : this.$store.getters['authToken']
        },
        params: {
