<template>
    <div>
      ...
      <el-alert
        title="CONTROLLA I CAMPI NEL FILE XLSX"
        type="warning"
        description="Le Voci 'Inizio_Periodo_Fatturazione' e 'Fine_Periodo_Fatturazione' sono OBBLIGATORIE E DEVONO ESSERE FORMATO STRINGA. "
        show-icon>
      </el-alert>
      <el-divider></el-divider>
      <el-upload
  ...
  data: () => {
   ...
   methods: {
     ...
     //send call the api to upload files using axios or any other means
       this.$axios.post('/api/fatturazione-passiva/start', fd,{
