<template>
    <div>
      <h2><i class="el-icon-tickets"></i> Generazione di file XML con file .dic di piccole dimensioni</h2>
      <el-divider></el-divider>
       <el-alert
        title="Il Gestore File accetta solo file .DIC"
        type="warning"
  ...
  data: () => {
   ...
   methods: {
     ...
     uploadFunction(){
      ...
      fd.append("dic_file", this.fileList[0]);
     //send call the api to upload files using axios or any other means
       this.$axios.post('/api/agenzia-dogane/start-single', fd,{
