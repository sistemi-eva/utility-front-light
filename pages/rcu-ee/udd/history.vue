...
<script>
import esporta from "@/components/rcu-ee/udd/esporta.vue";
import importa from "@/components/rcu-ee/udd/importa.vue";
import check from "@/components/rcu-ee/udd/check.vue";
...
export default {
  ...
  methods: {
    statusCache() {
      this.$axios
        .get("/api/rcu-ee/udd/status-cache", {
          headers: {
    ...
    deleteCache() {
      this.$axios
        .get("/api/rcu-ee/udd/delete-cache", {
          headers: {
            "Secret-Key": this.$store.getters["authToken"],
          },
        })
    ...
    refreshCache() {
      this.$axios
        .get("/api/rcu-ee/udd/refresh-cache", {
          headers: {
            "Secret-Key": this.$store.getters["authToken"],
          },
        })
    ...
    deleteFatt(id) {
      this.$confirm("Ricorda che verrano eliminati tutti i record relativi questa importazione.", "Sei sicuro di voler cancellare questo elemento?", {
        ...
        .then(() => {
          ...
          this.$axios
            .post(
              "/api/rcu-ee/udd/delete-fatturazione",
              { id },
              {
                headers: { "Secret-Key": this.$store.getters["authToken"] },
              }
