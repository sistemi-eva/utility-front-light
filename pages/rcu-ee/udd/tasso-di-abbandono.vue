...
export default {
  ...
  methods: {
    ...
    async ragioneSocialeCC() {
      await this.$axios.get('/api/rcu-ee/udd/societa', {
        headers:{
          'Secret-Key' : this.$store.getters['authToken']
        },
        params: {
    ...
    async chartPerditaPod() {
      await this.$axios.get('/api/rcu-ee/udd/chart-perdita-pod-information', {
        headers:{
          'Secret-Key' : this.$store.getters['authToken']
        },
        params: {
    ...
    async chartDetailPod() {
      await this.$axios.get('/api/rcu-ee/udd/chart-perdita-dettaglio-pod-information', {
        headers:{
          'Secret-Key' : this.$store.getters['authToken']
        },
        params: {
