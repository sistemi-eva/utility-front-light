...
<div v-if="!showError">
  ...
  <el-col :span="24">
    <span style="font-size:20pt; font-weight:600">Tasso di abbadono avanzato</span><br>
  ...
  <el-row :gutter="20">
    <el-col style="padding-top:20px; text-align:right" :span="24">
      <el-form ref="form" label-width="120px">
        ...
        <el-select @change="updateAll" v-if="tenant == 'ugm'" clearable  style="padding-left:10px;padding-right:10px;width:218px" v-model="selectedInvioFattura" placeholder="Mod. Invio fatture">
          <el-option
        ...
        <el-select @change="updateAll" clearable v-if="tenant == 'ugm'"  style="padding-left:10px;padding-right:10px;width:218px" v-model="selectedFilterPagamento" placeholder="Mod. Pagamento">
          <el-option
        ...
        <el-select @change="updateAll()" width="150px" style="padding-left:10px;padding-right:10px;width:218px" v-model="annoSelezionato" placeholder="Anno">
          <el-option
        ...
        <el-button type="primary" @click="emitExport = true">Esporta</el-button>
        <el-button  type="primary" @click="hideOperations">{{hideQuarter ?  'Nascondi Mensilità' : 'Mostra Mensilità'}}</el-button>
      </el-form>
    </el-col>
  </el-row>
...
export default {
  ...
  methods: {
    ...
    async tablePerditaPod() {
      await this.$axios.get('/api/rcu-ee/cc/table-tasso-abbandono', {
        headers:{
          'Secret-Key' : this.$store.getters['authToken']
        },
        params: {
