      ...
      <el-col style="text-align:right" :span="20">
        <el-form ref="form" label-width="120px">
          ...
          <el-select
            ...
            placeholder="Modalità visualizzazione"
          >
            <el-option
...
export default {
  ...
  data() {
    return {
      ...
      typeView: [
        { label: "Valori Assoluti", value: "assoluti" },
        { label: "Valori Percentuale", value: "percentuale" },
      ],
      lastAnnoImport:"",
      annoSelezionato: "",
      meseSelezionato: "",
  ...
  methods: {
    ...
    async updateAll() {
      ...
      this.$axios
        .get("/api/rcu-ee/cc/check-sintesi", {
          headers: {
            "Secret-Key": this.$store.getters["authToken"],
          },
          params: {
    ...
    async chartAndamentoVolumi() {
      await this.$axios
        .get("/api/rcu-ee/cc/att-dis-volumi", {
          headers: {
            "Secret-Key": this.$store.getters["authToken"],
          },
          params: {
