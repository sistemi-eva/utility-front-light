 ...
 components: {
  ...
  methods: {
    ...
    esporta(){
      ...
      this.$axios.post('/api/rcu-ee/cc/esportazione/', {anno:this.annoSelezionato},{
    ...
    async chartPod3YearsInformation(){
      this.$axios.get('/api/rcu-ee/cc/chart-pod-3years-information', {
        headers:{
          'Secret-Key' : this.$store.getters['authToken']
        },
        params: {
    ...
    async chartVolumi3YearsInformation(){
      this.$axios.get('/api/rcu-ee/cc/chart-volumi-3years-information', {
        headers:{
          'Secret-Key' : this.$store.getters['authToken']
        },
        params: {
    ...
    async chartInformation(){
      this.$axios.get('/api/rcu-ee/cc/chart-information', {
        headers:{
          'Secret-Key' : this.$store.getters['authToken']
        },
        params: {
    ...
    async chartPodInformation(){
      this.$axios.get('/api/rcu-ee/cc/chart-pod-information', {
        headers:{
          'Secret-Key' : this.$store.getters['authToken']
        },
        params: {
    ...
    async chartPodDispacciamentoInformation(){
      this.$axios.get('/api/rcu-ee/cc/chart-pod-dispacciamento-information', {
        headers:{
          'Secret-Key' : this.$store.getters['authToken']
        },
        params: {
    ...
    async tablePodInformation(){
      this.$axios.get('/api/rcu-ee/cc/table-pod-information', {
        headers:{
          'Secret-Key' : this.$store.getters['authToken']
        },
        params: {
    ...
    async tableIncPodInformation(){
      this.$axios.get('/api/rcu-ee/cc/table-inc-pod-information', {
        headers:{
          'Secret-Key' : this.$store.getters['authToken']
        },
        params: {
    ...
    async tableVolumiInformation(){
      this.$axios.get('/api/rcu-ee/cc/table-volumi-information', {
        headers:{
          'Secret-Key' : this.$store.getters['authToken']
        },
        params: {
    ...
    async tableIncVolumiInformation(){
      this.$axios.get('/api/rcu-ee/cc/table-inc-volumi-information', {
        headers:{
          'Secret-Key' : this.$store.getters['authToken']
        },
        params: {
