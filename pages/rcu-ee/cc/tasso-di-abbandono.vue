            ...
            <div slot="header" class="clearfix">
              <div style="display:flex;align-items:center;justify-content: space-between;">
                ...
                <div style="display:flex;justify-content:center;align-items:center">
                  ...
                  <div slot="content">
                    <h2>Riscontro grafico tra punto iniziale e punto attuale con approfondimento mensile in percentuale </h2>
                  </div>
...
export default {
  ...
  methods: {
    ...
    async ragioneSocialeCC() {
      await this.$axios.get('/api/rcu-ee/cc/societa', {
        headers:{
          'Secret-Key' : this.$store.getters['authToken']
        },
        params: {
    ...
    async chartPerditaPod() {
      await this.$axios.get('/api/rcu-ee/cc/chart-perdita-pod-information', {
        headers:{
          'Secret-Key' : this.$store.getters['authToken']
        },
        params: {
    ...
    async chartDetailPod() {
      await this.$axios.get('/api/rcu-ee/cc/chart-perdita-dettaglio-pod-information', {
        headers:{
          'Secret-Key' : this.$store.getters['authToken']
        },
        params: {
