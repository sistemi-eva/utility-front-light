<template>
  <el-card v-loading="loading" class="box-card">
    ...
    <apexchart ref="chartDisattivazioni" type="line" height="300" :options="chartOptions" :series="series"></apexchart>
  </el-card>
</template>
<script>
export default {
  ...
  methods: {
    updateChart(){
      ...
      if(Object.keys(this.chart).length > 0) {
        let typeFornitura = this.type == 'ee' ? 'Gwh' : 'Smc'
